...
<body>
	...
	<div class="box" style="line-height: .59rem">
		<ul>1.</ul>
		<ul>2.</ul>
		<ul>3.</ul>
		<ul>4.</ul>
	...
	<div class="container">
		<div class="row justify-content-md-center">
			<div class="Page1 float-left">
				<a href="../album/a.php" target="_blank"><img src="image/robindra_songit.png" alt="" height="200px"></a>
			</div>
			<div class="Page2 float-left ml-5">
				<a href="../album/a.php" target="_blank"><img src="image/nazrul_songit.png" alt="" height="200px"></a>
			</div>
