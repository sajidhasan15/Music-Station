...
// For adding post  
 ...
 // Where the file is going to be placed
       $target_path = "../album/song2/Audios/".$new_file_name;
...
{
 echo '<a href="../album/song2/b.php?name='.$row['filename'].'">'.$row['filename'].'</a>';
 echo "<br/>";    
}
mysqli_close($conn);
}
...
<head>
    ...
    <!-- App title -->
    <title>Music Station | Demo Page</title>
...
// Feching active categories
                                ...
                                <!-- <input type="submit" name="Submit" id="Submit" value="Submit"/> -->
                                <button type="submit" name="Submit" id="Submit" value="Submit" class="btn btn-success waves-effect waves-light">Save and Post</button>
